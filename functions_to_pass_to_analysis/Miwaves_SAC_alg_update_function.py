...
### changes from Synthetic dataset: synthetic_SAC_alg_update_function.py
"""
- dim is set to 8
"""

def Miwaves_SAC_alg_update_function(
    ...
    def active_branch(_):
        ...
        vector_pi = (-vector_pi.reshape(-1) + 2 * actor_ridge_penalty * beta_pi)
