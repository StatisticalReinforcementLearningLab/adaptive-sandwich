...
def oralytics_RL_estimating_function_only_mean_as_beta(
    posterior_mean: jnp.ndarray,
    ut_sigma_inv_flat: jnp.ndarray,
    ...
    beta = jnp.concatenate([posterior_mean, ut_sigma_inv_flat])
    ...
    # IN THIS CASE THAT MEANS ONLY RETURNING THE MU COMPONENT! Ignore
