...
RL_alg="smooth_posterior_sampling" # important !!!!!! fixed_randomization: evaluate reward variance, otherwise smooth_posterior_sampling to evaluate the true theta; --Miwaves_habituation=-1 also needs to be changed
