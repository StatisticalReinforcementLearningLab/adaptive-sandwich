...
inference_func_filename="functions_to_pass_to_analysis/inference_partial_linear_regression_01.py"
...
theta_calculation_func_filename="functions_to_pass_to_analysis/estimate_theta_avg_reward_diff_partial_01.py"
...
filename="_01env_alpha1${alpha1}_alpha2${alpha2}"
