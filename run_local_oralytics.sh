...
rl_loss_func_filename="functions_to_pass_to_analysis/oralytics_RL_loss.py"
rl_loss_func_args_beta_index=0
rl_loss_func_args_action_prob_index=4
rl_loss_func_args_action_prob_times_index=5
...
python after_study_analysis.py analyze-dataset \
  ...
  --rl_loss_func_args_pickle="${output_folder}/${seed}_loss_fn_data.pkl" \
