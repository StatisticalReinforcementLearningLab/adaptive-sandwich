...
if [ -z "$index_to_check_ci_coverage" ]; then
  python -m lifejacket.after_study_analysis collect-existing-analyses --input_glob="${input_glob}" --num_users="${num_users}" --study_df_filename="${study_df_filename}" --in_study_col_name=$in_study_col_name --action_col_name=$action_col_name --action_prob_col_name=$action_prob_col_name
else
  python -m lifejacket.after_study_analysis collect-existing-analyses --input_glob="${input_glob}" --num_users="${num_users}" --study_df_filename="${study_df_filename}" --index_to_check_ci_coverage="${index_to_check_ci_coverage}" --in_study_col_name=$in_study_col_name --action_col_name=$action_col_name --action_prob_col_name=$action_prob_col_name
fi
