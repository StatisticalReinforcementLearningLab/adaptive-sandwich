...
def test_RL_center_0_inf_center_1_steep_3_incremental(
    ...
    run_local_pipeline(
        ...
        inference_func_filename="functions_to_pass_to_analysis/get_least_squares_estimating_function_inference_action_centering.py",
        inference_func_type="estimating",
        alg_update_func_filename="functions_to_pass_to_analysis/get_least_squares_estimating_function_rl.py",
