...
def test_RL_center_0_inf_center_1_steep_3_incremental(
    ...
    assert_real_run_output_as_expected(
        ...
        relative_path_to_output_dir="../../../simulated_data/synthetic_mode=delayed_1_action_dosage_alg=sigmoid_LS_T=10_n=100_recruitN=20_decisionsBtwnUpdates=2_steepness=3.0_algfeats=intercept,past_reward_errcorr=time_corr_actionC=1/exp=1",
    )
